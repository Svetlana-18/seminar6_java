...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Unicornshop unicorn2 = new Unicornshop(350000, "Агата", 240, formatter.parse("Sat, April 1, 2022"), false, 2,
                200000);
        Unicornshop unicorn3 = new Unicornshop(420000, "Регат", 140, formatter.parse("Sat, May 23, 2021"), true, 3,
                300000);
        Unicornshop unicorn4 = new Unicornshop(290000, "Афродита", 220, formatter.parse("Sat, December 13, 2020"),
                false, 4, 150000);
        Unicornshop unicorn5 = new Unicornshop(340000, "Карат", 60, formatter.parse("Sat, May 1, 2023"), true, 5,
                200000);
        Unicornshop unicorn6 = new Unicornshop(300000, "Лана", 40, formatter.parse("Sat, April 1, 2018"), false, 6,
                300000);
